...
namespace Kitaplik_Proje
{
    public partial class Form1 : Form
    {
        ...
        OleDbConnection baglanti = new OleDbConnection(@"Provider=Microsoft.Jet.OLEDB.4.0;Data Source=C:\Users\selva\Desktop\Kitaplık.mdb");
        ...
        private void btn_kitapbul_Click(object sender, EventArgs e)
        {
        ...
        {
            OleDbCommand komut = new OleDbCommand("Select * From kitaplar where KitapAd like '%"+ txt_kitapbul.Text +"%' ", baglanti);
            DataTable dt = new DataTable();
            OleDbDataAdapter da = new OleDbDataAdapter(komut);
            da.Fill(dt);
            dataGridView1.DataSource = dt;
